...
namespace Intersect.Client.UnityGame.FileManagement {
	...
	public class AssetReferences : ScriptableObject {
		...
		private void OnValidate() {
			...
			LoadTexture(ref entities, ENTITIES_PATH, TextureType.Entity);
			LoadTexture(ref paperdolls, PAPERDOLL_PATH, TextureType.Paperdoll);
		...
		private void LoadTexture(ref List<UnityTexture> textures, string path, TextureType textureType) {
			if (textures is null) {
